...
class AdminPsblogBlogsController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->bulk_actions = array('delete' => array('text' => $this->module->getTranslator()->trans('Delete selected'), 'confirm' => $this->module->getTranslator()->trans('Delete selected items?'), 'icon' => 'icon-trash'));
        $this->fields_list = array(
            'id_psblog_blog' => array('title' => $this->module->getTranslator()->trans('ID'), 'align' => 'center', 'class' => 'fixed-width-xs'),
            'meta_title' => array('title' => $this->module->getTranslator()->trans('Blog Title'), 'filter_key' => 'b!meta_title'),
            'title' => array('title' => $this->module->getTranslator()->trans('Category Title'), 'filter_key' => 'cl!title'),
            'active' => array('title' => $this->module->getTranslator()->trans('Displayed'), 'align' => 'center', 'active' => 'status', 'class' => 'fixed-width-sm', 'type' => 'bool', 'orderby' => false)
        );
...
//      $tree = $obj->getTree();    # validate module
        ...
        $this->fields_form[0]['form'] = array(
            'tinymce' => true,
            'legend' => array(
                'title' => $this->module->getTranslator()->trans('Blog Form'),
            ...
            'input' => array(
                ...
                array(
                    'type' => 'tags',
                    'label' => $this->module->getTranslator()->trans('Tags'),
                    'name' => 'tags',
                    'lang' => true,
                    'hint' => array(
                ...
                array(
                    'type' => 'file',
                    'label' => $this->module->getTranslator()->trans('Thumb image'),
                    'name' => 'thumb',
                    'display_image' => true,
                    'default' => '',
                    'desc' => $this->module->getTranslator()->trans(''),
                ...
                array(
                    'type' => 'textarea',
                    'label' => $this->module->getTranslator()->trans('Video Code'),
                    'name' => 'video_code',
                    'rows' => 5,
                    'cols' => 30,
                    'hint' => $this->module->getTranslator()->trans('Enter Video Code Copying From Youtube, Vimeo').' <>;=#{}'
                ),
                array(
                    'type' => 'textarea',
                    'label' => $this->module->getTranslator()->trans('Blog description'),
                    'name' => 'description',
                    'autoload_rte' => true,
                    'lang' => true,
                    'rows' => 5,
                ...
                array(
                    'type' => 'textarea',
                    'label' => $this->module->getTranslator()->trans('Blog Content'),
                    'name' => 'content',
                    'autoload_rte' => true,
                    'lang' => true,
                    'rows' => 5,
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->module->getTranslator()->trans('Indexation (by search engines):'),
                    'name' => 'indexation',
                    'required' => false,
                    'class' => 't',
                    'is_bool' => true,
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->module->getTranslator()->trans('Displayed:'),
                    'name' => 'active',
                    'required' => false,
                    'is_bool' => true,
                    'values' => array(
        ...
        $this->fields_form[1]['form'] = array(
            'tinymce' => true,
            'legend' => array(
                'title' => $this->module->getTranslator()->trans('SEO'),
                'icon' => 'icon-folder-close'
            ),
            'input' => array(
                // custom template
        ...
        /*      if (Shop::isFeatureActive())
          ...
          'type' => 'shop',
          'label' => $this->module->getTranslator()->trans('Shop association:'),
    ...
    {
        $this->toolbar_title = $this->module->getTranslator()->trans('Blogs Management');
    ...
    public function displayList($token = null)
    {
        ...
        if (!count($this->_list)) {
            echo '<tr><td class="center" colspan="'.(count($this->fields_list) + 2).'">'.$this->module->getTranslator()->trans('No items found').'</td></tr>';
        }
