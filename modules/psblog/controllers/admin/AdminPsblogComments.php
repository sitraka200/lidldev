...
//		$this->list_id = 'id_comment';		// must be set same value $this->table to delete multi rows
        ...
        $this->fields_list = array(
            'id_comment' => array('title' => $this->module->getTranslator()->trans('ID'), 'align' => 'center', 'class' => 'fixed-width-xs'),
            'id_psblog_blog' => array('title' => $this->module->getTranslator()->trans('Blog ID'), 'align' => 'center', 'class' => 'fixed-width-xs'),
            'user' => array('title' => $this->module->getTranslator()->trans('User')),
            'comment' => array('title' => $this->module->getTranslator()->trans('Comment'), 'filter_key' => 'b!Comment'),
            'date_add' => array('title' => $this->module->getTranslator()->trans('Date Added'), 'filter_key' => 'b!data_add'),
    ...
    public function initPageHeaderToolbar()
    {
        ...
        if (Tools::getValue('id_psblog_blog')) {
            $this->page_header_toolbar_btn['back-blog'] = array(
                ...
                'desc' => $this->module->getTranslator()->trans('Back To The Blog'),
    ...
    public function renderForm()
    {
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'hidden',
                    'label' => $this->module->getTranslator()->trans('Comment ID'),
                    'name' => 'id_comment',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->module->getTranslator()->trans('Blog Title'),
                    'name' => 'blog_title',
                ),
                array(
                    'type' => 'text',
                    'label' => $this->module->getTranslator()->trans('User'),
                    'name' => 'user',
                ),
                array(
                    'type' => 'text',
    ...
    {
        $this->toolbar_title = $this->module->getTranslator()->trans('Comments Management');
