...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmcmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmcmsblockinfo_lang` il ON il.`id_tmcmsblockinfo` = i.`id_tmcmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmcmsblockinfo->text = reset($customTexts);
