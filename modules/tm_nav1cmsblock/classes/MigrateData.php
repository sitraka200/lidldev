...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmnav1cmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmnav1cmsblockinfo_lang` il ON il.`id_tmnav1cmsblockinfo` = i.`id_tmnav1cmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmnav1cmsblockinfo->text = reset($customTexts);
