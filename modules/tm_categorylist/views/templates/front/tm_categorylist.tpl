...
<div  class="tmcategorylist">
	<div class="tmcategory-container container hb-animate-element left-to-right">
		...
		<div class="row">
			<h2 class="h1 products-section-title ">{l s='Shop by department' d='Shop.Theme.Global'}</h2>
			<div class="menu-title">{l s='choose what you looking for' d='Shop.Theme.Global'}</div>
