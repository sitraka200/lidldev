...
{if $tmrightbanner1.slides}
	<div id="tmrightbanner1">
		<ul class="hidden-md-down">
			{foreach from=$tmrightbanner1.slides item=slide}
  ...
  <h4 class="block_title hidden-lg-up" data-target="#block_banner2_toggle" data-toggle="collapse">{l s='rightbanner1' d='Shop.Theme'}
