...
<ul class="clearfix footer_links">
	<li><a class="btn btn-default button button-small" title="{l s='Back to Login' mod='privateshop'}" rel="nofollow" href="javascript:void(0);" 
onclick="BackToLogin();"><span><i class="icon-chevron-left"></i>{l s='Back to Login' mod='privateshop'}</span></a></li>
</ul>
