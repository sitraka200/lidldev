...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmcms2blockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmcms2blockinfo_lang` il ON il.`id_tmcms2blockinfo` = i.`id_tmcms2blockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmcms2blockinfo->text = reset($customTexts);
