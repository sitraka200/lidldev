...
<div id="everpspopup_block_center" data-delay="{$everpspopup->delay|escape:'htmlall':'UTF-8'}" data-adult="{$everpspopup->adult_mode|escape:'htmlall':'UTF-8'}" data-expire="{$everpspopup->cookie_time|escape:'htmlall':'UTF-8'}" class="Everpopup_block" style="display:none;{if $background}background-image: url({$background|escape:'htmlall':'UTF-8'});background-size:cover;{/if}">
