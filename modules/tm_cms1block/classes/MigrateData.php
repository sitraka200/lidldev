...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmcms1blockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmcms1blockinfo_lang` il ON il.`id_tmcms1blockinfo` = i.`id_tmcms1blockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmcms1blockinfo->text = reset($customTexts);
