...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmcms3blockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmcms3blockinfo_lang` il ON il.`id_tmcms3blockinfo` = i.`id_tmcms3blockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmcms3blockinfo->text = reset($customTexts);
