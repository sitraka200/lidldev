    ...
    <!-- <i class="material-icons">&#xE324;</i> -->
	  ...
	  <li class="email">
        ...
        {l
          s='[1]%email%[/1]'
          sprintf=[
            '[1]' => '<a href="mailto:'|cat:$contact_infos.email|cat:'" class="dropdown"><img class="svg-image img-responsive" src="http://lidl-cse-entzheim-fr.mon.world/cselidlentzheim/img/cms/svg/envelope.svg" alt="mail-01.svg" />',
            '[/1]' => '</a>',
