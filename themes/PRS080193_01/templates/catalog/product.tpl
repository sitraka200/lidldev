      ...
      <div class="col-md-7 product_middle">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="productpage_title" itemprop="name">{block name='page_title'}{$product.name}{if Manufacturer::getNameById($product->id_manufacturer)|count_characters }- {Manufacturer::getNameById($product->id_manufacturer)}{/if}{/block}</h1>
            {/block}
          {/block}
            ...
            <div class="right_cms">
              <div id="tmsmartblog_block">
                <div id="tmcmsbannerblock">
                  <div class="container">
                    <div class="subbanner">
                      <div class="cms-banner-item col-xs-6 col-lg-12">
                        <div class="col-xs-12">
                          <div class="sub-title">Formulaires</div>
                        </div>
                        
                        <div class="col-xs-12">
                          <img src="http://lidl-cse-entzheim-fr.mon.world/cselidlentzheim/img/cms/notepad-01.png" alt="notepad-01.png">
                        </div>
                        
                        <div class="col-xs-12">
                          <div class="button"><a href="#" class="btn btn-primary">Y accéder</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
   ...
   {block name='product_tabs'}  
    <div class="tabs">
              <ul class="nav nav-tabs">
                ...
                {/if}
                <li class="nav-item">
                  <a class="nav-link {if !$product.description} active{/if}" data-toggle="tab" href="#rating">{l s='rating' d='Shop.Theme.Catalog'}</a>
                </li>
