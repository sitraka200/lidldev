						...
						<div class="blog-item">
							{if $blog.image}
								...
								<span class="blogicons">
									<a title="{l s='Click to view Full Image' d='Shop.Theme.Global'}" href="{$blog.preview_url|escape:'html':'UTF-8'}" data-lightbox="example-set" class="icon zoom"></a> 
									<a title="{l s='Click to view Read More' d='Shop.Theme.Global'}" href="{$blog.link|escape:'html':'UTF-8'}" class="icon readmore_link"></a>
								</span>
