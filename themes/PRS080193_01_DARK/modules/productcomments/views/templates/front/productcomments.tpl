...
<div id="productCommentsBlock">
    <h1 class="h1 products-section-title text-uppercase ">{l s='Reviews' d='Shop.Theme.Global'}</h1>
    <div class="tabs">
                    ...
                    <div class="new_comment_form_content">
                        ...
                        <div id="new_comment_form_footer">
                            ...
                            <p class="fr">
                                ...
                                {/literal}
                                    {l s='I accept ' d='Shop.Theme.Global'} <a target="_blank" href="{$link->getCmsLink($PRODUCT_COMMENTS_GDPRCMS)}">{l s='privacy policy' mod='productcomments'}</a> {l s='rules' d='Shop.Theme.Global'}
                                {/if}
