    ...
    <div class="product-description">
      <div class="top-description">
        ...
        {block name='product_name'}
          ...
          {* Add Manufacturer name near the product name *}
          <span class="h3 product-title" itemprop="name"><a href="{$product.url}">{$product.name}{if Manufacturer::getNameById($product->id_manufacturer)|count_characters }- {Manufacturer::getNameById($product->id_manufacturer)}{/if}</a></span>
        {/block}
      </div>
