...
$(document).ready(function() {
	...
	/**
	 * Change the default options of lighbox
	 * @see https://lokeshdhakar.com/projects/lightbox2/index.html#options
	 */
    lightbox.option({
      'albumLabel': 'Image %1 de %2',
    });

    if ($('.product_list.gridcount.grid').length) {
    	/**
        ...
        function gridNormalization() {
            var items = $( '.products .product_list li.product_item' ), //grab all slides
        ...
        function removeGridNormalization() {
            var items = $( '.products .product_list li.product_item' );
            items.each( function() {
